...
const Tv = () => {
  ...
  const filtered = filterNewsByMunicipio(["acara", "pará"]);
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>TV | EN Belterra</title>
          <meta property="og:title" content="TV É Notícia Belterra" />
          <meta
